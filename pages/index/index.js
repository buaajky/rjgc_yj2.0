...
Page({
    ...
    getAds(){
      var that = this
      var url = utils.server_hostname + "/api/core/ads/"
      ...
      wx.request({
        ...
        success: function(res) {
          // console.log(res)
          var adlist = res.data.results

          var ad_ids = that.data.ad_ids
          var ad_titles = that.data.ad_titles
          var ad_covers = that.data.ad_covers
          var ad_urls = that.data.ad_urls
          for (var i in adlist) {
            var ad = adlist[i]
            // console.log(ad)
